...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        # output activation function is f(x) = x
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        derivative_output_activation = 1.0
        output_error_term = error * derivative_output_activation
              
        # TODO - DONE: Calculate the hidden layer's contribution to the error
        hidden_error = np.dot(self.weights_hidden_to_output, output_error_term)
        
        derivative_hidden_activation = hidden_outputs * (1 - hidden_outputs)
        hidden_error_term = hidden_error * derivative_hidden_activation
...
##########################################################
iterations = 10000  # when using varying learning rate and in submission: 10000, otherwise: 4000
learning_rate = 1.0 # when using varying learning rate and in submission: 1.0, otherwise: 0.5
hidden_nodes = 5    # in submission: 5, otherwise: 4
output_nodes = 1
